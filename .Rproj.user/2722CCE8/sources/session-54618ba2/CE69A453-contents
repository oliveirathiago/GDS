...
names(models_purchase) <- c(
  "m_scen1_purchase_crime", "m_scen2_purchase_crime", "m_scen3_purchase_crime", "m_scen4_purchase_crime", 
  "m_scen5_purchase_crime", "m_scen6_purchase_crime",
  "m_scen1_purchase_encour", "m_scen2_purchase_encour", "m_scen3_purchase_encour", "m_scen4_purchase_encour", 
  "m_scen5_purchase_encour", "m_scen6_purchase_encour",
  "m_scen1_purchase_free", "m_scen2_purchase_free", "m_scen3_purchase_free", "m_scen4_purchase_free", 
  "m_scen5_purchase_free", "m_scen6_purchase_free",
  "m_scen1_purchase_health", "m_scen2_purchase_health", "m_scen3_purchase_health", "m_scen4_purchase_health", 
  "m_scen5_purchase_health", "m_scen6_purchase_health",
  "m_scen1_purchase_vulner", "m_scen2_purchase_vulner", "m_scen3_purchase_vulner", "m_scen4_purchase_vulner", 
  "m_scen5_purchase_vulner", "m_scen6_purchase_vulner",
  "m_scen1_purchase_econ", "m_scen2_purchase_econ", "m_scen3_purchase_econ", "m_scen4_purchase_econ", 
  "m_scen5_purchase_econ", "m_scen6_purchase_econ",
  "m_scen1_purchase_trust", "m_scen2_purchase_trust", "m_scen3_purchase_trust", "m_scen4_purchase_trust", 
  "m_scen5_purchase_trust", "m_scen6_purchase_trust"
)
...
models_purchase_scen1 <- list(crime = m_scen1_purchase_crime, econ = m_scen1_purchase_econ, encour = m_scen1_purchase_encour, free = m_scen1_purchase_free, 
                            health = m_scen1_purchase_health, trust = m_scen1_purchase_trust, vulner = m_scen1_purchase_vulner) %>%
...
models_purchase_scen2 <- list(crime = m_scen2_purchase_crime, econ = m_scen2_purchase_econ, encour = m_scen2_purchase_encour, free = m_scen2_purchase_free, 
                            health = m_scen2_purchase_health, trust = m_scen2_purchase_trust, vulner = m_scen2_purchase_vulner) %>%
  lapply(clean_model_results) %>%
  imap_dfr(~mutate(.x, model = .y)) %>%
...
models_purchase_scen3 <- list(crime = m_scen3_purchase_crime, econ = m_scen3_purchase_econ, encour = m_scen3_purchase_encour, free = m_scen3_purchase_free, 
                            health = m_scen3_purchase_health, trust = m_scen3_purchase_trust, vulner = m_scen3_purchase_vulner) %>%
  lapply(clean_model_results) %>%
  imap_dfr(~mutate(.x, model = .y)) %>%
...
models_purchase_scen4 <- list(crime = m_scen4_purchase_crime, econ = m_scen4_purchase_econ, encour = m_scen4_purchase_encour, free = m_scen4_purchase_free, 
                            health = m_scen4_purchase_health, trust = m_scen4_purchase_trust, vulner = m_scen4_purchase_vulner) %>%
  lapply(clean_model_results) %>%
  imap_dfr(~mutate(.x, model = .y)) %>%
...
models_purchase_scen5 <- list(crime = m_scen5_purchase_crime, econ = m_scen5_purchase_econ, encour = m_scen5_purchase_encour, free = m_scen5_purchase_free, 
                            health = m_scen5_purchase_health, trust = m_scen5_purchase_trust, vulner = m_scen5_purchase_vulner) %>%
  lapply(clean_model_results) %>%
  imap_dfr(~mutate(.x, model = .y)) %>%
...
models_purchase_scen6 <- list(crime = m_scen6_purchase_crime, econ = m_scen6_purchase_econ, encour = m_scen6_purchase_encour, free = m_scen6_purchase_free, 
                            health = m_scen6_purchase_health, trust = m_scen6_purchase_trust, vulner = m_scen6_purchase_vulner) %>%
  lapply(clean_model_results) %>%
  imap_dfr(~mutate(.x, model = .y)) %>%
...
all_models <-
  models_purchase_scen1 %>%
  bind_rows(models_purchase_scen2) %>%
  bind_rows(models_purchase_scen3) %>%
  bind_rows(models_purchase_scen4) %>%
  bind_rows(models_purchase_scen5) %>%
  bind_rows(models_purchase_scen6) %>%
...
term_labels <- c(
  ...
  "purchaseYes, but not in the last 12 months" = "Purchased illegal drugs, not in the last 12 months",
  "purchaseYes, in the last 12 months" = "Purchased illegal drugs in the last 12 months"
)
...
export_to_word <- function(ft_list, scenario_name) {
  ...
  output_file <- paste0("tables - models Purchase/model_purchase_results_", scenario_name, ".docx")
